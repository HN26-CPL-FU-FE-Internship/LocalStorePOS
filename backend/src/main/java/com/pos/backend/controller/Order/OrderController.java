...
public class OrderController {
    ...
    @GetMapping("/stats")
    @PreAuthorize("@perm.hasPermission(authentication, 'Orders', 'view')")
    ...
    @PreAuthorize("@perm.hasPermission(authentication, 'Orders', 'edit')")
    ...
    @PostMapping("/{id}/pay")
    @PreAuthorize("@perm.hasPermission(authentication, 'Orders', 'add')")
