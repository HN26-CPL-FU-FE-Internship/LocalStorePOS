...
public class POSController {
    ...
    @PreAuthorize("@perm.hasPermission(authentication, 'POS', 'view')")
    ...
    @PreAuthorize("@perm.hasPermission(authentication, 'POS', 'add')")
    ...
    @PreAuthorize("@perm.hasPermission(authentication, 'POS', 'edit')")
