...
public class PermissionService {
    ...
    private static final Map<String, Map<String, DefaultPerm>> DEFAULT_PERMISSIONS = Map.ofEntries(
            ...
            entry("Supervisor", Map.ofEntries(
                    ...
                    entry("Hold/Resume Sale", new DefaultPerm(true, true, true, false, false, false)),
                    entry("Refund / Return", new DefaultPerm(true, true, false, false, false, true)),
                    ...
                    entry("Manage Staffs", new DefaultPerm(true, false, false, false, false, false)),
            ...
            entry("Cashier", Map.ofEntries(
                    ...
                    entry("Hold/Resume Sale", new DefaultPerm(true, true, false, false, false, false)),
                    entry("Refund / Return", new DefaultPerm(true, false, false, false, false, false)),
                    ...
                    entry("Kitchen (KDS)", new DefaultPerm(false, false, false, false, false, false)),
                    ...
                    entry("Manage Staffs", new DefaultPerm(false, false, false, false, false, false)),
                    entry("Audit Logs", new DefaultPerm(false, false, false, false, false, false)))),
            /* -- Chef -- */
            entry("Chef", Map.ofEntries(
                    ...
                    entry("Hold/Resume Sale", new DefaultPerm(false, false, false, false, false, false)),
                    entry("Refund / Return", new DefaultPerm(false, false, false, false, false, false)),
                    entry("Products", new DefaultPerm(true, false, false, false, false, false)),
                    entry("Categories", new DefaultPerm(true, false, false, false, false, false)),
            ...
            entry("Waiter", Map.ofEntries(
                    ...
                    entry("Reservation", new DefaultPerm(true, true, true, false, false, false)),
                    entry("Kitchen (KDS)", new DefaultPerm(true, false, false, false, false, false)),
            ...
            entry("Accountant", Map.ofEntries(
                    ...
                    entry("POS", new DefaultPerm(false, false, false, false, false, false)),
                    entry("Hold/Resume Sale", new DefaultPerm(false, false, false, false, false, false)),
                    entry("Refund / Return", new DefaultPerm(true, false, false, false, false, true)),
                    entry("Products", new DefaultPerm(true, false, false, false, false, false)),
                    entry("Categories", new DefaultPerm(true, false, false, false, false, false)),
                    entry("Customers", new DefaultPerm(true, false, false, false, false, false)),
                    entry("Reports", new DefaultPerm(true, false, false, false, true, false)),
