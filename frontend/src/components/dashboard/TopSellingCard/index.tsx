                ...
                <div className="top-selling-featured d-flex align-items-center mb-3">
                    {canViewItems ? (
                        <a href="/items" className="avatar avatar-lg avatar-rounded me-2 flex-shrink-0">
                            {featured.imageUrl && (
                                <img src={getAssetUrl(featured.imageUrl)} alt="food" className="img-fluid rounded-circle" />
                            )}
                        </a>
                    ) : (
                        <div className="avatar avatar-lg avatar-rounded me-2 flex-shrink-0">
                            {featured.imageUrl && (
                                <img src={getAssetUrl(featured.imageUrl)} alt="food" className="img-fluid rounded-circle" />
                            )}
                        </div>
                    ...
                    <div>
                        <h6 className="fs-14 fw-semibold mb-1">
                            {canViewItems ? (
                                ...
                                <span className="text-dark">{featured.name}</span>
                            )}
                        </h6>
