...
const baseOrder: OrderSummary = {
    ...
    note: null,
    items: [
        { id: 1, itemName: 'Burger', quantity: 2, kitchenNote: null, sizeName: null, unitPrice: 10, addons: [] },
        { id: 2, itemName: 'Fries', quantity: 1, kitchenNote: null, sizeName: null, unitPrice: 5, addons: [] },
    ],
};
