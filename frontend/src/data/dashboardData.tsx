import categoryImages from '@/assets/img/category';
import type {
    StatCardData,
...
export const topSellingItems: TopSellingItem[] = [
    {
        ...
        imageUrl: categoryImages['category-02'],
        orders: 520,
        progressPercent: 100,
        color: 'primary',
    },
...
export const trendingMenus: TrendingMenu[] = [
    {
        ...
        imageUrl: '/restaurant-pos/src/assets/img/menu/menu-01.jpg',
        orders: 48,
        dietType: 'Non Veg',
    },
    {
        id: 'm2',
        name: 'Grilled Veggie',
        imageUrl: '/restaurant-pos/src/assets/img/menu/menu-02.jpg',
        orders: 99,
        dietType: 'Non Veg',
    },
    {
        id: 'm3',
        name: 'Chicken Noodle',
        imageUrl: '/restaurant-pos/src/assets/img/menu/menu-03.jpg',
        orders: 59,
        dietType: 'Non Veg',
    },
    {
        id: 'm4',
        name: 'Corn Pizza',
        imageUrl: '/restaurant-pos/src/assets/img/menu/menu-04.jpg',
        orders: 69,
        dietType: 'Veg',
    },
    {
        id: 'm5',
        name: 'Pumpkin Soup',
        imageUrl: '/restaurant-pos/src/assets/img/menu/menu-05.jpg',
        orders: 78,
        dietType: 'Veg',
    },
    {
        id: 'm6',
        name: 'Hot Chocolate',
        imageUrl: '/restaurant-pos/src/assets/img/menu/menu-06.jpg',
        orders: 99,
        dietType: 'Veg',
    },
];
