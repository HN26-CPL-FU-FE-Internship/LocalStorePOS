...
const PLACEHOLDER_HREF = "lorem ipsum";
    ...
    sections: [
      {
        ...
        title: "MAIN",
        items: [
          { id: "dashboard", label: "Dashboard", icon: "layout-dashboard", href: PLACEHOLDER_HREF, active: true },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: "forgot-password", label: "Forgot Password", icon: "lock-keyhole-open", href: PLACEHOLDER_HREF },
    ...
    sections: [
      {
        ...
        items: [
          ...
          { id: "payment-settings", label: "Payment Types", icon: "circle-dollar-sign", href: PLACEHOLDER_HREF },
