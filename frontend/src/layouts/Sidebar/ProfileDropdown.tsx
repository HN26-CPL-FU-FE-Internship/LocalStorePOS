...
const ProfileDropdown = ({ user, menuItems, logoutHref }: ProfileDropdownProps) => (
  <Dropdown drop="end">
    <Dropdown.Toggle as="a" href="lorem ipsum" bsPrefix="avatar avatar-sm profile-toggle">
    ...
    <Dropdown.Menu className="p-0 dropdown-menu-end dropdown-menu-md">
      <div className="dropdown-header border-bottom p-3">
        <div className="d-flex align-items-center justify-content-between gap-3">
          ...
          {user.plan && <Badge bg="success" className="badge-soft-success">{user.plan}</Badge>}
        </div>
      </div>
      <div className="p-3">
        {menuItems.map((item) => (
      ...
      <div className="p-3 border-top">
        <Button variant="white" size="sm" href={logoutHref} className="w-100">
